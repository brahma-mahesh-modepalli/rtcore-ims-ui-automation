...
export interface Rcsp206AssignItemToCountLocationData {
  assignItemData: Rcsp206AssignItemToCountLocation[];
}

export interface Rcsp206AssignItemToCountLocation {
  locationName: string;
  countFrequency: string;
  items: Rcsp206AssignItems[];
}

export interface Rcsp206AssignItems {
  sku: string;
  itemName: string;
}
