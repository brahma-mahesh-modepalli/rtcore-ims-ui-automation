/**
 * RCSP-237 – Transfers end-to-end automation
 * Test case IDs use TC_RCSP-237_* format.
 */
...
const RCSP_237_FILE_NAME = 'RCSP-237';
const RCSP_237_SCENARIO_ID = 'RCSP-237';

const TC = {
  hierarchyOpen: 'TC_RCSP-237_001',
  hierarchySelect: 'TC_RCSP-237_002',
  storeContext1034: 'TC_RCSP-237_003',
  switchStore1025: 'TC_RCSP-237_004',
  openInventoryBalances: 'TC_RCSP-237_005',
  onHand1034: 'TC_RCSP-237_006',
  onHand1025: 'TC_RCSP-237_007',
  invalidInventorySearch: 'TC_RCSP-237_008',
  openTransfers: 'TC_RCSP-237_009',
  openNewTransferForm: 'TC_RCSP-237_010',
  createDraft: 'TC_RCSP-237_011',
  draftInAll: 'TC_RCSP-237_012',
  draftInDraftTab: 'TC_RCSP-237_013',
  draftDetailsActions: 'TC_RCSP-237_014',
  submitDraftToPending: 'TC_RCSP-237_015',
  pendingVisibleOn1025: 'TC_RCSP-237_016',
  rejectPending: 'TC_RCSP-237_017',
  rejectBlankReason: 'TC_RCSP-237_018',
  declinedOn1034: 'TC_RCSP-237_019',
  directSubmit: 'TC_RCSP-237_020',
  approvePending: 'TC_RCSP-237_021',
  onHandIncrement1025: 'TC_RCSP-237_022',
  transferInDashboard: 'TC_RCSP-237_023',
  onHandDecrement1034: 'TC_RCSP-237_024',
  transferOutDashboard: 'TC_RCSP-237_025',
  validationFromStore: 'TC_RCSP-237_026',
  validationToStore: 'TC_RCSP-237_027',
  validationReason: 'TC_RCSP-237_028',
  validationNoItems: 'TC_RCSP-237_029',
  validationZeroQty: 'TC_RCSP-237_030',
  validationSameStore: 'TC_RCSP-237_031',
  validationInsufficientStock: 'TC_RCSP-237_032',
  cancelDraft: 'TC_RCSP-237_033',
  rejectModalNo: 'TC_RCSP-237_034',
  approveModalNo: 'TC_RCSP-237_035',
  completedNoActions: 'TC_RCSP-237_036',
  declinedNoApprove: 'TC_RCSP-237_037',
  saveDraftChanges: 'TC_RCSP-237_038',
  transfersPageLayout: 'TC_RCSP-237_039',
  decimalQuantity: 'TC_RCSP-237_040',
  receivingCannotInitiate: 'TC_RCSP-237_041',
  reasonCodes: 'TC_RCSP-237_042',
  otherReasonRequiresNotes: 'TC_RCSP-237_043',
  endToEndApprove: 'TC_RCSP-237_044',
  financialRecord: 'TC_RCSP-237_045',
  exportPrintDetails: 'TC_RCSP-237_046',
  exportPrintDashboard: 'TC_RCSP-237_047',
} as const;
...
test.describe("RCSP-237 - My Hierarchy: Logged-in admin user can open the My Hierarchy page from the main navigation menu", () => {
...
test.describe("RCSP-237 - My Hierarchy: Admin user can select Region, Market, and Store from the My Hierarchy page and view sto...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - My Hierarchy: Currently selected store is displayed in the top-right corner of the Home page after se...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - My Hierarchy: Admin user can switch the active store from WB Unit 1034 to WB Unit 1025 using the My H...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Inventory Balances: Admin user can navigate to Inventory > Inventory Balances page from the main menu while...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Inventory Balances: ON HAND quantity and FIFO COST values are displayed correctly for item LARGE BUNS 11201...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Inventory Balances: Inventory Balances page displays no records or an appropriate message when searching fo...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Admin user can navigate to the Transfers page from the main menu while WB Unit 1034 is...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Admin user can open the New Transfer form by clicking the NEW TRANSFER button on the Tr...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Admin user can create a new Transfer in Draft status by filling transfer header details...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Recently created Transfer appears in the All section of the Transfers page with Draft s...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Recently created Draft transfer is visible in the Draft section of the Transfers page o...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Clicking a Draft transfer record opens the Draft Details page with CANCEL, SAVE CHANGES...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Admin user can submit a Draft transfer and the transfer status changes to Pending on WB...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Pending transfer sent from WB Unit 1034 is visible on the Transfers page when viewed fr...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Reject Transfer modal prevents rejection when the mandatory Reason field is left blank...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Destination store user can reject a Pending transfer with a reason and the transfer sta...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Declined transfer status is reflected on the Transfers page when viewed from the source...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Admin user can create and directly submit a new Transfer from WB Unit 1034 to WB Unit 1...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Destination store user can approve a Pending transfer and the transfer status changes t...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Inventory Balances: ON HAND quantity for LARGE BUNS 11201 is incremented by 1 on WB Unit 1025 Inventory Bal...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Dashboard: Recent Stock Movements section on the Dashboard displays a Transfer In record for LARGE...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Inventory Balances: ON HAND quantity for LARGE BUNS 11201 is decremented by 1 on WB Unit 1034 Inventory Bal...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Dashboard: Recent Stock Movements section on the Dashboard displays a Transfer Out record for LARG...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: New Transfer form displays validation when mandatory From Store field is not selected o...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: New Transfer form displays validation when mandatory To Store field is not selected on...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: New Transfer form displays validation when mandatory Transfer Reason field is not selec...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: New Transfer form prevents submission when no item is added to the transfer on WB Unit...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: New Transfer form prevents submission when item quantity is entered as 0 on WB Unit 1034", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: New Transfer form prevents creating a transfer when From Store and To Store are the sam...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: New Transfer form blocks submission and displays an insufficient stock message when Qty...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Admin user can cancel a Draft transfer from the Draft Details page on WB Unit 1034", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Clicking NO on the Reject Transfer confirmation modal keeps the transfer in Pending sta...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Clicking NO on the Approve Transfer confirmation modal keeps the transfer in Pending st...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Completed transfer cannot be rejected or approved again on WB Unit 1025", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Declined transfer cannot be approved on WB Unit 1025", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Admin user can save changes to a Draft transfer and the updated details are retained on...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Transfers page on WB Unit 1034 displays the NEW TRANSFER button, status section tabs, a...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: New Transfer form rejects decimal/fractional Qty to Order and accepts only whole number...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Transfer can be initiated only by the sending unit and users logged into the receiving...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Transfer Reason dropdown on the New Transfer form displays all valid reason codes with...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Selecting Transfer Reason \"Other\" requires a mandatory comment in the Notes field befor...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Admin user can create, submit, and approve a transfer end-to-end from WB Unit 1034 to W...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: System creates a financial record when a transfer is completed from WB Unit 1034 to WB...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Transfer details and summary are exportable and printable as a transfer receipt from th...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
...
test.describe("RCSP-237 - Transfers: Transfer receipt is exportable and printable from the Dashboard page for a recently com...", () => {
  let loginPage: RTCDashboardLoginPage;
  let transfersPage: TransfersPage;
